          ...
          <Row className="align-items-center">
            ...
            <Col md={6} data-aos="fade-left">
              ...
              <p className="text-white">
                2022年12月3日正式以職業啦啦隊員出道的廉世彬，當時先參與職業男子排球 KEPCO Vixtorm Volleyball Team 以及職業女子排球 Hana Bank Women's Basketball Team的應援工作，當時受到的關注度還不高
              </p>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          <Row className="align-items-center flex-md-row-reverse">
            ...
            <Col md={6} data-aos="fade-right">
              ...
              <p className="text-white">
                2023年正式加入起亞虎隊應援團，而這兩年她也分別和邊荷律以及李珠珢成為隊友。2024年在韓國的網路論《Dctrend》上舉辦了一個職業啦啦隊人氣投票，而她最終以12,817票擊敗權熙媛、李珠珢以及李多慧拿下冠軍，也被封為2024年度職業啦啦隊女王，人氣也是在這時期快速上升。除了職業啦啦隊工作外，2024年11月12日廉世彬以藝名Snooze發表個人參與創作的單曲새벽감성，顯示出她多才多藝的面向。
              </p>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          <Row className="align-items-center">
            ...
            <Col md={6} data-aos="fade-left">
              ...
              <p className="text-white">
                在季初宣布加入NC恐龍隊，隨後在2月26日宣布加入台灣樂天桃猿隊，IG粉絲也在今年突破10萬，個人相關周邊商品總是銷售一空。在今年6月16日以Snooze名字發行個人第二張單曲Cherry Blooming，即將在7月19日中華職棒明星賽參與開幕表演，並且會在明星賽期間在球場內快閃店「好厝邊 Hasubeen」攜手知名餐飲品牌「饗食天堂」聯名推出韓式料理，首度圓夢當店長，販賣韓國美食啦啦隊女王廉世彬的故事還在繼續，帶給粉絲們驚喜
              </p>
            </Col>
          </Row>
        </Container>
