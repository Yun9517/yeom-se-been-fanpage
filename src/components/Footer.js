      ...
      <Container>
        <Row className="align-items-center">
          ...
          <Col md={6} className="text-md-end">
            <a href="https://www.instagram.com/beena._s2/" target="_blank" rel="noopener noreferrer" className="text-white mx-2" aria-label="廉世彬的 Instagram">
            ...
            <a href="https://www.youtube.com/@MyAsteroids2" target="_blank" rel="noopener noreferrer" className="text-white mx-2" aria-label="廉世彬的 YouTube">
            ...
            <a href="https://www.threads.com/@beena._s2" target="_blank" rel="noopener noreferrer" className="text-white mx-2" aria-label="廉世彬的 Threads">
